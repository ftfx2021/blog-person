...
//@Slf4j
//
//public class ArticleEsServiceNew {
//
//
//    @Resource
...
//        //创建映射
//        indexOperations.putMapping(ArticleDocument.class);
//
//    }
//    /**
//     *删除索引
...
//     * 添加单个文档
//     */
//    public void addOrUpdateDocument(ArticleDocument document) throws IOException {
//        ArticleDocument save = elasticsearchOperations.save(document);
//        log.info("ES文章创建:{}",save.getId());
//
//    }
//
//    /**
