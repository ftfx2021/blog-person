...
public enum FileBusinessTypeEnum {
    ...
    // 心情日记相关
    MOOD_DIARY("PRODUCT_IMAGE", "商品图片", new String[]{"IMG"}),
    MOOD_IMAGE("PRODUCT_COVER", "商品封面", new String[]{"IMG"}),
    ...
    // 文章相关
    ARTICLE("ARTICLE", "文章", new String[]{"IMG", "PDF", "DOC"}),
    ARTICLE_COVER("ARTICLE_COVER", "文章封面", new String[]{"IMG"}),
    ARTICLE_CONTENT("ARTICLE_CONTENT", "文章内容图片", new String[]{"IMG"}),
    
    // 评论相关
    COMMENT_IMAGE("COMMENT_IMAGE", "评论图片", new String[]{"IMG"}),
    
    // 友情链接相关
    FRIEND_LINK_LOGO("FRIEND_LINK_LOGO", "友情链接LOGO", new String[]{"IMG"}),
