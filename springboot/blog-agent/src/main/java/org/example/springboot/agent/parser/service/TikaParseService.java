package org.example.springboot.agent.parser.service;
...
public class TikaParseService {
    ...
    public ParseResult parseFile(MultipartFile file) throws IOException, TikaException, SAXException {
        ...
        log.info("开始解析{}，文件大小：{}bytes",originalFilename,file.getSize());
