...
export async function runMigrations(configuration: MysqlConnectionConfiguration, directory: string): Promise<MigrationResult> {
  ...
  try {
    ...
    for (const file of files) {
      ...
      try {
        ...
        await connection.query('INSERT INTO schema_migrations (id, applied_at) VALUES (?, UTC_TIMESTAMP(3))', [file])
