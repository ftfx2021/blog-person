...
import { calculateMilestoneProgress, calculateNumericProgress } from '../../src/shared/domain/progress.js'
import { nextTaskStatus, transitionGoal, transitionProject } from '../../src/shared/domain/state-machines.js'
import { calculateDailyStreak, calculateWeeklyStreak } from '../../src/shared/domain/streak.js'
...
describe('习惯连续周期', () => {
  it('按相邻自然日计算 daily streak', () => expect(calculateDailyStreak(['2026-08-20', '2026-08-19', '2026-08-18', '2026-08-16'])).toBe(3))
  it('按连续达标周计算 weekly streak', () => expect(calculateWeeklyStreak(['2026-08-18', '2026-08-20', '2026-08-11', '2026-08-12'], 2)).toBe(2))
})
